...
```bash
export NO_PROXY_VAL="localhost,127.0.0.1,.amazonaws.com,.s3.${AWS_REGION}.amazonaws.com,s3.${AWS_REGION}.amazonaws.com,sts.amazonaws.com,sts.${AWS_REGION}.amazonaws.com,${EGRESS_VPC_CIDR},${CDP_VPC_CIDR}"
